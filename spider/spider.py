...
from .utils import config_util, datetime_util
...
class Spider:
    def __init__(self, config):
        ...
        self.since_date = str(
            since_date)  # Begining to grab the data. format: yyyy-mm-dd
        self.end_date = config[
            'end_date']  # Ending time. format: yyyy-mm-dd，#"now" represent the time now
    ...
    def _get_filepath(self, type):
        ...
        try:
            ...
            if FLAGS.output_dir is not None:
                ...
                file_dir = (os.getcwd() + os.sep + 'results' + os.sep + dir_name)
